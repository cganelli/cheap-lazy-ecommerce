...
export default function DisclosureSection() {
  return (
    <section
      id="disclosure"
      // scroll margin prevents the sticky header from covering the anchor target
      className="scroll-mt-28 md:scroll-mt-32 rounded-xl bg-slate-50 p-4 md:p-6 border"
